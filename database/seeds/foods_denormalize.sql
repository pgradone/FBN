...
SELECT i.id, i.foodgroup_id, in_en.name food_name_EN, in_fr.name food_name_FR,
	fgn_en.name sub_group_EN, fgn_fr.name sub_group_FR
	from ingredients i 
...
left join foodgroup_names fgn_en on fg_sub.id = fgn_en.foodgroup_id and fgn_en.language_id = 2
left join foodgroup_names fgn_fr on fg_sub.id = fgn_fr.foodgroup_id and fgn_fr.language_id = 3
